...
Solving this dual optimization problem in polynomial time is non-trivial, but it has been done in [recent work](https://arxiv.org/abs/1711.02036). For the sake of brevity, we won’t state the dual or discuss specifics of this problem here. 
