...
---
In May 2018, the European Union enacted the [General Data Protection Regulation (GDPR)](https://en.wikipedia.org/wiki/General_Data_Protection_Regulation), the [toughest personal data privacy law in the world](https://www.nytimes.com/2018/05/24/technology/europe-gdpr-privacy.html). Two plus years later, the GDPR has levied several multimillion Euro fines, and other countries and states within the U.S. have proposed or passed similar legislation, [using the GDPR as a template](https://techcrunch.com/2020/02/08/ccpa-privacy-law-rocky-start/). But politicians and pundits still debate: what is the net effect of the GDPR for EU consumers and markets?
...
- Will the total volume of personal data in the market under the GDPR increase or decrease? Critics worry that the opt-in requirement will throttle the amount of data available to firms. 
- Under what conditions does the law benefit consumers? Europe’s data protection authority declared the EU needed “a comprehensive approach on personal data protection” and [cites the privacy component](https://gdpr.eu/what-is-gdpr/) of the European Convention on Human Rights as a key raison d’etre, making consumer welfare central to the regulation. 
- Are there circumstances where the law will increase firm profit? Are firm profit and consumer surplus at odds or can consumer surplus lead to a concomitant increase in firm profits?
...
One of the key contributions of the model to the existing literature is the endogenization of personal data choices on the part of firms and consumers; the model includes these decisions as features and tries to determine how they are affected by the other parameters. Concretely, the model allows for consumers to decide to opt in or opt out of data sharing in the first period, and for consumers to keep, delete or transfer their data associated with a given firm in the second period. The paper also separately analyzes the model when breach costs are exogenous (due to developments in technology out of the control of a firm) or endogenous (a result of privacy and security practices within the control of the firm). As we will see in the next sections, whether or not firms can control the cost of data breaches plays a significant role in the degree to which the GDPR is beneficial for consumer and firm surplus.

## Personal data markets subject to the GDPR: what to expect

To make predictions about how the market will behave with and without data privacy regulations, Ke and Sudhir solve for equilibrium in the game described in the previous section. The strategies of customers and firms in equilibrium determine market segmentation: based on the expected costs associated with data breaches $$ c $$ and the personalization preferences $$ \kappa_H, \kappa_L $$, it is possible to see which consumers will purchase the good, whether they will share their data and how firms will set prices. The different behaviors of these segments of the population determines consumer and firm surplus as well as the volume of data in the market.

According to Ke and Sudhir’s analysis of the model, monopolistic markets ($$n=1$$) and competitive markets ($$n>1$$) behave differently.

Let’s consider the monopolistic market first. Under the regulation, consumers have the right to opt out of data collection, and since they are averse to privacy breach costs, a segment of the population won’t share their data. Because of this, firms cannot be sure that they will be able to collect consumers’ personal data and therefore less willing to subsidize the basic product before any data is collected, relative to a market without the GDPR. Also, because of the right to erasure, consumers can better protect themselves from data breaches and are therefore willing to pay a higher price for the product. Thus, prices for the basic product will go up. Prices for the personalized product, however, may go down. This is because firms cannot price discriminate as effectively, since consumers always have the option of switching to the basic product.

There are several other nuances to this picture, which we can understand better by considering the chart below from the paper. Let’s explain the yellow, green and red areas of the chart according to the findings of the paper.
...
On the vertical axis, $$v$$, is the customer valuation. On the horizontal axis $$c$$, is the privacy breach cost. Customers with low valuations of the product, $$ v < 0.5 $$ will not buy the product at all, so the privacy regulation won’t make a difference for them (yellow region). Things get more complicated for the top half of the graph (green and red regions). The high valuation customers benefit from privacy rights for most settings of breach cost $$c$$. For high valuation consumers and lower breach costs, customers risk very little by sharing their data and benefit from protections against price discrimination under privacy rights. So these consumers are better off under the GDPR (green region on the left). For high valuation consumers and high breach costs, customers are to some degree protected from breach costs by the right to erasure. These customers also benefit from protections against price discrimination, so they are better off under the GDPR (green region on the right). For high valuation customers and intermediate breach costs, customers are averse to sharing their data because of the breach costs and companies are not willing to subsidize the price of the basic good. So consumers are better off without privacy rights for intermediate values of $$c$$. For more details, see section 3 of the paper.

Competitive markets ($$n > 1$$), according to Ke and Sudhir’s analysis, are similar to monopolistic ones, except that the competition drives the price for the basic product down during the first period, and the ability for firms to price discriminate is even more weakened, since the threat for customers to transfer their data to a competitor is credible. Thus, their analysis finds that privacy rights lead to higher consumer surplus for all customers and lower firm profits for all breach costs $$ c $$.

Ke and Suhir also address how choosing whether data breaches are endogenous or exogenous features of the model can change the dominant effects of the GDPR on consumer welfare and firm profits. In the analysis above, they assume that privacy breach costs are exogenous to firms; the firms each have the same privacy breach costs, which are a result of technological factors primarily outside of their control as long as the firms meet baseline GDPR security requirements. However, when privacy breach costs are endogenous, firms can invest in their own security in order to reduce expected privacy breach costs. The market equilibrium changes: Ke and Sudhir find small increases in firm profits and consumer surplus when breach costs are endogenous relative to when they are exogenous.
